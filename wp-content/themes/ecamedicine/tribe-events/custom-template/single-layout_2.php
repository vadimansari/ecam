                ...
                <div class="events-left">
                    ...
                    <?php while (have_posts()): the_post();?>
                        ...
                        <?php if ($tbe_event_countdown == true) :?>
                              <div class="events-coundwon events-coundwon-2 bg_cover" data-overlay="8" style="background-image: url('<?php echo esc_url(get_the_post_thumbnail_url($event_id, 'large')); ?>')">
